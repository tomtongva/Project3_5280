...
class GameViewModel @Inject constructor(
    ...
    fun onCardClick(card: Card, hostHand: Boolean, plusFourColor: String) {
        viewModelScope.launch(showErrorExceptionHandler) {
            if(GoogleFunctionsEnabled) {
                ...
                functionService.playCard(game.value.hostId, hostHand, plusFourColor).addOnCompleteListener { response ->
    ...
    fun localPlayCard(card: Card, hostHand: Boolean, plusFourColor: String) {
    ...
    fun localDrawCard(hostHand: Boolean, plusFourColor: String) {
        var editedGame = game.value.copy()
    ...
    fun localLeaveGame(openAndPopUp: (String, String) -> Unit) {
        var editedGame = game.value.copy()
